...
public class SparkOperationsPractice {
	...
	public static void main(String[] args) {
		...
		JavaPairRDD<String, Double[]> irisSumKV = irisKV.reduceByKey(new Function2<Double[], Double[], Double[]>() {					
		...
		// Now find average
		JavaPairRDD<String, Double> irisAvgKV = irisSumKV.mapValues(x -> x[0] / x[1]);
